  ...
  '/guide/': [
    ...
    },
    {
      ...
      items: [
        ...
        { text: '在线日志与追踪', link: '/guide/client/logging' },
    ...
    },
    {
      text: '可观测性',
      items: [
        { text: '可观测性概述', link: '/guide/observability/' },
        { text: '追踪详情', link: '/guide/observability/trace' },
        { text: '统计分析', link: '/guide/observability/analytics' },
        { text: '评分系统', link: '/guide/observability/score' },
      ],
    },
    {
      text: '其他功能',
  ...
  '/api/': [
    {
      ...
      items: [
        ...
        { text: '记忆 API', link: '/api/admin/memory' },
    ...
    },
    {
      ...
      items: [
        ...
        { text: '知识库查询', link: '/api/openapi/rag' },
      ],
    },
  ],
  '/deploy/': [
