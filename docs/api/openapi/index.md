...
| 智能体对话会话 Token | 已支持 | `snail-ai-server/snail-ai-server-openapi/src/main/java/com/aizuda/snail/ai/openapi/controller/OpenApiEmbedController.java` |
...
| Chat 会话 Token | `GET/POST /embed-token` | 生成智能体对话会话 Token |
