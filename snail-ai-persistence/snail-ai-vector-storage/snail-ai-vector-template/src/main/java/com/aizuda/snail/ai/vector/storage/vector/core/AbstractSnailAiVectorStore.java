...
public abstract class AbstractSnailAiVectorStore implements SnailAiVectorStore {
    ...
    protected final SnailEmbeddingModel snailEmbeddingModel;
    ...
    protected AbstractSnailAiVectorStore(SnailEmbeddingModel snailEmbeddingModel,
                                         Integer embeddingDimensions) {
        this.snailEmbeddingModel = snailEmbeddingModel;
        this.embeddingDimensions = embeddingDimensions;
        if (Objects.isNull(snailEmbeddingModel)) {
            springAiEmbeddingModel = null;
            return;
        }
        springAiEmbeddingModel = snailEmbeddingModel.toSpringAiEmbeddingModel();
    }
